...
public class Deck2 {
	...
	public Deck2(String initialDeck){
	...
	public int vectorDistance(ArrayList finalDeck, boolean SpecificCards){
	...
	public int hammingDistance(ArrayList finalDeck, boolean SpecificCards){
		int points=0;
		if (!SpecificCards){
			for(int i=0;i<this.CurrentDeckOrder.size();i++){
			...
			for(int i=0;i<this.CurrentDeckOrder.size();i++){
				if(this.CurrentDeckOrder.get(i).equals(finalDeck.get(i))){
					if(!this.CurrentDeckOrder.get(i).equals("-")){
						if(!finalDeck.get(i).equals("-")){
							points=points+10;
						}
					}
				}
	...
	public int MixedDistanceSequenceHamming(ArrayList finalDeck, boolean SpecificCards){
				...
				for(int b=0; b<52; b++){
					for(int c=0; c<52; c++){
						for(int d=0; d<52; d++){
							...
							else if(technique.equals("HAMMING")&&!linePrinter.equals("")){linePrinter+=Integer.toString(hammingDistance(this.CurrentDeckOrder,true));}
							else if(technique.equals("SEQUENCE-HAMMING")&&!linePrinter.equals("")){linePrinter+=Integer.toString(MixedDistanceSequenceHamming(this.CurrentDeckOrder,true));}
	...
	public void metricAnalyzerN4LastPos(ArrayList<Integer> techniqueSet, Integer numberOfSametech, String metric, String technique){
		...
		while (i<techniqueSet.size()+4){
			...
			for(int d=0; d<52; d++){
				...
				//aplicar metrica aqui para obtener resultados de la combinación actual
				if(metric.equals("SEQUENCE")&&!linePrinter.equals("")){linePrinter+=Integer.toString(vectorDistance(modifiedDeck.getCurrentDeckOrder(),true));}
				else if(metric.equals("HAMMING")&&!linePrinter.equals("")){linePrinter+=Integer.toString(hammingDistance(modifiedDeck.getCurrentDeckOrder(),true));}
				else if(metric.equals("SEQUENCE-HAMMING")&&!linePrinter.equals("")){linePrinter+=Integer.toString(MixedDistanceSequenceHamming(modifiedDeck.getCurrentDeckOrder(),true));}
				if(!linePrinter.equals("")){if(cont==1000000||cont==3000000||cont==10000000||cont==20000000||cont==30000000||cont==40000000||cont==50000000){System.out.println(cont);}csvWriter.append(linePrinter+"\n");	cont++;}
				linePrinter="";
				doDeckToBackupState();
			}
	...
	public static void main(String[] args) {
		Deck2 Baraja = new Deck2("[b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r]");
		//eck = Baraja.stringToArrayListDeck("[1s, 2s, 3s, 4s, 5s, 6s, 7s, 8s, 9s, 10s, 11s, 12s, 13s, 1h, 2h, 3h, 4h, 5h, 6h, 7h, 8h, 9h, 10h, 11h, 12h, 13h, 13d, 12d, 11d, 10d, 9d, 8d, 7d, 6d, 5d, 4d, 3d, 2d, 1d, 13c, 12c, 11c, 10c, 9c, 8c, 7c, 6c, 5c, 4c, 3c, 2c, 1c]");
		...
		//String Deck= "[b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, r, r, r, r, r, r, r, r, r, b, r, b, r, r, r, r, r, b, r, b, r, r, r, r, r, b, r, b, r, r, r, r]";
		//outfaroup 26 outfaro 32 infaro 16 outfaro 16 outfaroup 20 
		//SEQ
		//String Deck= "[b, b, b, b, b, b, b, b, b, b, b, b, b, r, r, r, r, r, r, r, r, r, r, r, r, r, r, r, r, b, b, b, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r, b, r]";
		//infaro 16 outfaro 17 infaro 16 infaro 15 
		Baraja.inPartialFaroCurrentDeck(16);
		Baraja.outPartialFaroCurrentDeck(17);
		Baraja.inPartialFaroCurrentDeck(16);
		Baraja.inPartialFaroCurrentDeck(15);
