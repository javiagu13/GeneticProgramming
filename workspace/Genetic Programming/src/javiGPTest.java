...
public class javiGPTest {
	...
	*/
	...
	private int MUTATION=0; //Number of mutations (technique+number)
	private int MUTATIONUMBER=2000; //Number of mutations (technique+number) REVISE CODEEEEEE
	private int MUTATIONOPERATION=1000; //Number of mutations (technique+number) REVISE CODEEEEEE
	...
	private int LENGTHMAXOFTREE=10*2;
