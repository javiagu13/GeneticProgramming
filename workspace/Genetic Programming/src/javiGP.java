	...
	*/
    ...
    public void evolvePopulation() throws CloneNotSupportedException{
    	...
    	for (int i =0; i<this.population.size();i++){
    		...
    		int numOfTechniques=0;
    		if(this.DISTANCE.equals("SEQUENCE")){
    			Distance=testIndividualWithDistanceVector(this.initialDeckString, this.desiredDeckString, currenTree);
    			if(this.TECHNUM_CONSTRAINT.equals("YES")){
					numOfTechniques=currenTree.size()/2;
					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
					Distance=Distance-numOfTechniques;
				}
			}
    		else if(this.DISTANCE.equals("HAMMING")){
				Distance=testIndividualWithHammingDistance(this.initialDeckString, this.desiredDeckString, currenTree);
				if(this.TECHNUM_CONSTRAINT.equals("YES")){
					numOfTechniques=currenTree.size()/2;
					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
					Distance=Distance-numOfTechniques;
				...
				Distance=testIndividualWithMixedDistanceHammingSequence(this.initialDeckString, this.desiredDeckString, currenTree);
				if(this.TECHNUM_CONSTRAINT.equals("YES")){
					numOfTechniques=currenTree.size()/2;
					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
					Distance=Distance-numOfTechniques;
    		...
    		for(int j = 0; j<this.NUMPARAMOPTIMIZATION; j++){
        		...
        		numOfTechniques=0;
        		if(this.DISTANCE.equals("SEQUENCE")){
        			newDistance=testIndividualWithDistanceVector(this.initialDeckString, this.desiredDeckString, paramTweakTree);
        			if(this.TECHNUM_CONSTRAINT.equals("YES")){
    					numOfTechniques=currenTree.size()/2;
    					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
    					newDistance=newDistance-numOfTechniques;
    				}
    			}
        		else if(this.DISTANCE.equals("HAMMING")){
        			newDistance=testIndividualWithHammingDistance(this.initialDeckString, this.desiredDeckString, paramTweakTree);
    				if(this.TECHNUM_CONSTRAINT.equals("YES")){
    					numOfTechniques=currenTree.size()/2;
    					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
    					newDistance=newDistance-numOfTechniques;
    				...
    				newDistance=testIndividualWithMixedDistanceHammingSequence(this.initialDeckString, this.desiredDeckString, paramTweakTree);
    				if(this.TECHNUM_CONSTRAINT.equals("YES")){
    					numOfTechniques=currenTree.size()/2;
    					numOfTechniques=numOfTechniques*this.TECHNUM_PENALIZATION;
    					newDistance=newDistance-numOfTechniques;
